...
export const getMyInfo = (data) => async (dispatch) => {
    const url = 'http://15.164.97.230:9001/mypage/getMyInfo';
...
export const updateMyInfo = (formData) => async (dispatch) => {
    const url = 'http://15.164.97.230:9001/mypage/updateMyInfo';
...
export const updateInterest = (checkList) => async (dispatch) => {
    const url = 'http://15.164.97.230:9001/mypage/updateInterest';
    const id = localStorage.getItem("user_id");
...
export const getInterest = () => async (dispatch) => {
    const url = 'http://15.164.97.230:9001/mypage/getInterest';
    const id = localStorage.getItem("user_id");
...
export const getMyCoupon = () => async (dispatch) => {
    const url = 'http://15.164.97.230:9001/mypage/getMyCoupon';
    const id = localStorage.getItem("user_id");
...
export const couponCount = () => async (dispatch) => {
    const url = 'http://15.164.97.230:9001/mypage/couponCount';
    const id = localStorage.getItem("user_id");
...
//     const url = 'http://15.164.97.230:9001/mypage/applyCoupon';
//     const id = localStorage.getItem("user_id");
...
export const applyCoupon = (couponCode) => async (dispatch) => {
    ...
    if (result && result[0]) {
      ...
      // 쿠폰 다시 불러오기
      const refreshUrl = 'http://15.164.97.230:9001/mypage/getMyCoupon';
...
export const customTheme = (category) => async (dispatch) => {
    const url = 'http://15.164.97.230:9001/mypage/customTheme';
  ...
  export const customArea = async () => {
    const id = localStorage.getItem('user_id');
    const url = 'http://15.164.97.230:9001/mypage/customArea';
